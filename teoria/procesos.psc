...
Proceso provaFunciones
	...
	Escribir "Cridem a la funci�n calcularDoble(realEntrat) amb variable pasada per valor.";
    ...
    Escribir "Cridem a la funci�n triplicar(realEntrat) amb variable pasada per valor.";
...
// Exemple de funci� que rep un argument per valor, i torna el doble d'aquest
Funcion doble <- calcularDoble(numRebut) 
	Definir doble Como Real;
	doble <- numRebut * 2; // retorna el doble
FinFuncion

// Exemple de funci� que rep un argument per refer�ncia, i el modifica
...
//	 Cridem a la funci�n calcularDoble(realEntrat) amb variable pasada per valor.
...
//	 Cridem a la funci�n triplicar(realEntrat) amb variable pasada per valor.
